...
bids_root = "/Volumes/T5_EVO/REPLAYSEQ/ICM/1-data_ICM/BIDS"
...
spatial_filter = "ssp" #NOTE DIFF
n_proj_eog = dict(n_mag=0, n_grad=0)
n_proj_ecg = dict(n_mag=2, n_grad=2)
ssp_reject_ecg = {"grad": 2000e-13, "mag": 5000e-15} #NOTE DIFF
reject = None
# Epochs
epochs_tmin = -0.2
...
# Noise estimation
process_empty_room = False #NOTE DIFF
